...
int main() {
    ...
    double max_err_custom_fixed4_28 = 0.0;
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        fk_return ret_custom_double = FK_Roarm2_double(
        ...
        fk_return ret_custom_float = FK_Roarm2_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3]
        ...
        fk_return ret_custom_fixed32 = FK_Roarm2_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3]
        ...
        // --- Custom Fixed4-28 Precision ---
        fk_return ret_custom_fixed4_28 = FK_Roarm2_fixed4_28(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3]
        );
        double current_err_fixed4_28 = calculate_forward_kinematics_error(ret_custom_fixed4_28, data_ref);
        max_err_custom_fixed4_28 = std::max(max_err_custom_fixed4_28, current_err_fixed4_28);

        // --- Custom Fixed16 Precision ---
        fk_return ret_custom_fixed16 = FK_Roarm2_fixed16(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3]
    ...
    std::cout << "Max error (Custom Fixed4-28 vs. Pinocchio Double): " << max_err_custom_fixed4_28 << std::endl;
