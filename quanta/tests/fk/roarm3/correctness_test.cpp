...
int main() {
    ...
    const std::string urdf_filename = PINOCCHIO_MODEL_DIR + std::string(
        ...
        "roarm_m3_description/roarm_m3_no_gripper.urdf");
    ...
    double max_err_custom_fixed5_27 = 0.0;
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        fk_return ret_custom_double = FK_Roarm3_double(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        );
        ...
        fk_return ret_custom_float = FK_Roarm3_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        fk_return ret_custom_fixed32 = FK_Roarm3_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        fk_return ret_custom_fixed5_27 = FK_Roarm3_fixed5_27(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        );
        double current_err_fixed5_27 = calculate_forward_kinematics_error(ret_custom_fixed5_27, data_ref);
        max_err_custom_fixed5_27 = std::max(max_err_custom_fixed5_27, current_err_fixed5_27);

        // --- Custom Fixed16 Precision ---
        fk_return ret_custom_fixed16 = FK_Roarm3_fixed16(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
    ...
    std::cout << "Max error (Custom Fixed5-27 vs. Pinocchio Double): " << max_err_custom_fixed5_27 << std::endl;
