    ...
    const pinocchio::DataTpl<double>& pinocchio_data) 
{
    ...
    for (int j = 0; j < NU; ++j) {
        ...
        // Note: The original code only compared rotation. If translation needs checking:
        for (int r = 0; r < 3; ++r) {
            current_iteration_max_err = std::max(current_iteration_max_err,
...
int main() {
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        // print limi_rotation of pinocchio data
        ...
        fk_return ret_custom_double = FK_Indy7_double(
        ...
        fk_return ret_custom_float = FK_Indy7_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        ...
        fk_return ret_custom_fixed32 = FK_Indy7_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        ...
        // --- Custom Fixed5-27 Precision ---
        fk_return ret_custom_fixed6_26 = FK_Indy7_fixed6_26(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        );
        double current_err_fixed6_26 = calculate_forward_kinematics_error(ret_custom_fixed6_26, data_ref);
        max_err_custom_fixed6_26 = std::max(max_err_custom_fixed6_26, current_err_fixed6_26);

        // --- Custom Fixed16 Precision ---
        fk_return ret_custom_fixed16 = FK_Indy7_fixed16(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        ...
        //std::cout << std::endl;
//
        //// print return from double
        //for(int i = 0; i < NU; i++) {
        //    printf("oMi %d: ", i);
        //    for(int j = 0; j < 3; j++){
        //        for(int k = 0; k < 3; k++){
        //            printf("%lf ", ret_custom_double.oMis[i].rotation[j][k]);
        //        }
        //        printf("\n");
        //    }
        //    printf("\n");
        //    printf("translation: ");
        //    for(int j = 0; j < 3; j++){
        //        printf("%lf ", ret_custom_double.oMis[i].translation[j]);
        //    }
        //    printf("\n");
        //}
        //printf("v: \n");
        ...
        //    printf("v %d: ", i);
        //    for(int j = 0; j < 6; j++){
        //        printf("%lf ", ret_custom_double.v[i][j]);
        //    }
        //    printf("\n");
        //}
        //printf("a: \n");
        ...
        //    printf("a %d: ", i);
        //    for(int j = 0; j < 6; j++){
        //        printf("%lf ", ret_custom_double.a[i][j]);
        //    }
        //    printf("\n");
        //}
//
        //// print return from fixed32
        //for(int i = 0; i < NU; i++) {
        //    printf("oMi %d: ", i);
        //    for(int j = 0; j < 3; j++){
        //        for(int k = 0; k < 3; k++){
        //            printf("%lf ", ret_custom_fixed32.oMis[i].rotation[j][k]);
        //        }
        //        printf("\n");
        //    }
        //    printf("\n");
        //    printf("translation: ");
        //    for(int j = 0; j < 3; j++){
        //        printf("%lf ", ret_custom_fixed32.oMis[i].translation[j]);
        //    }
        //    printf("\n");
        //}
        //printf("v: \n");
        ...
        //    printf("v %d: ", i);
        //    for(int j = 0; j < 6; j++){
        //        printf("%lf ", ret_custom_fixed32.v[i][j]);
        //    }
        //    printf("\n");
        //}
        //printf("a: \n");
        ...
        //    printf("a %d: ", i);
        //    for(int j = 0; j < 6; j++){
        //        printf("%lf ", ret_custom_fixed32.a[i][j]);
        //    }
        //    printf("\n");
        //}
//
        //// print errs
        //std::cout << "Current max error (Custom Double vs. Pinocchio Double): " << current_err_double << std::endl;
        //std::cout << "Current max error (Custom Float vs. Pinocchio Double):  " << current_err_float << std::endl;
        //std::cout << "Current max error (Custom Fixed32 vs. Pinocchio Double): " << current_err_fixed32 << std::endl;
//
        //exit(1);
