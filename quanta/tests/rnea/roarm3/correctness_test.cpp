...
int main() {
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        rnea_return ret_custom_double = RNEA_Roarm3_double(
        ...
        rnea_return ret_custom_float = RNEA_Roarm3_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        rnea_return ret_custom_fixed32 = RNEA_Roarm3_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        rnea_return ret_custom_fixed7_25 = RNEA_Roarm3_fixed7_25(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        );
        double current_err_fixed7_25 = calculate_error(ret_custom_fixed7_25, data_ref);
        max_err_custom_fixed7_25 = std::max(max_err_custom_fixed7_25, current_err_fixed7_25);

        // --- Custom Fixed16 Precision ---
        rnea_return ret_custom_fixed16 = RNEA_Roarm3_fixed16(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        //if(current_err_fixed16 > 1.0){
        //    std::cout << "curr tau: " << data_ref.tau.transpose() << std::endl;
        //    std::cout << "custom tau: " << std::endl;
        //    for (int j = 0; j < NU; ++j) {
