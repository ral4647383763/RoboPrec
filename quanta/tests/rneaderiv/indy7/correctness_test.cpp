...
int main() {
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        rneaderiv_return ret_custom_double = RNEADERIV_Indy7_double(
        ...
        rneaderiv_return ret_custom_float = RNEADERIV_Indy7_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        ...
        rneaderiv_return ret_custom_fixed32 = RNEADERIV_Indy7_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4], cos_q_vals[5],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4], sin_q_vals[5],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4], v_vals[5],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4], a_vals[5]
        ...
        //std::cout << "pinocchio dq: " << std::endl;
        //std::cout << djoint_torque_dq << std::endl;
        //std::cout << "custom dq: " << std::endl;
        //for(int qq = 0; qq < NU; ++qq) {
        //    for(int pp = 0; pp < NU; ++pp) {
        //        std::cout << ret_custom_double.partial_dq[qq][pp] << " ";
        //    }
        //    std::cout << std::endl;
        //}
        //std::cout << "pinocchio dv: " << std::endl;
        //std::cout << djoint_torque_dv << std::endl;
        //std::cout << "custom dv: " << std::endl;
        //for(int qq = 0; qq < NU; ++qq) {
        //    for(int pp = 0; pp < NU; ++pp) {
        //        std::cout << ret_custom_double.partial_dv[qq][pp] << " ";
        //    }
        //    std::cout << std::endl;
        //}
        //std::cout << "pinocchio da: " << std::endl;
        //std::cout << djoint_torque_da << std::endl;
        //std::cout << "custom da: " << std::endl;
        //for(int qq = 0; qq < NU; ++qq) {
        //    for(int pp = 0; pp < NU; ++pp) {
        //        std::cout << ret_custom_double.partial_da[qq][pp] << " ";
        //    }
        //    std::cout << std::endl;
        //}
