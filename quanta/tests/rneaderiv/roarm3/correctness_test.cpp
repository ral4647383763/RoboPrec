...
int main() {
    ...
    for (int i = 0; i < NUMBER_OF_SAMPLES; ++i) {
        ...
        rneaderiv_return ret_custom_double = RNEADERIV_Roarm3_double(
        ...
        rneaderiv_return ret_custom_float = RNEADERIV_Roarm3_float(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        rneaderiv_return ret_custom_fixed32 = RNEADERIV_Roarm3_fixed32(
            cos_q_vals[0], cos_q_vals[1], cos_q_vals[2], cos_q_vals[3], cos_q_vals[4],
            sin_q_vals[0], sin_q_vals[1], sin_q_vals[2], sin_q_vals[3], sin_q_vals[4],
            v_vals[0], v_vals[1], v_vals[2], v_vals[3], v_vals[4],
            a_vals[0], a_vals[1], a_vals[2], a_vals[3], a_vals[4]
        ...
        // rnea_return ret_custom_fixed13_19 = RNEA_Roarm3_fixed13_19(
